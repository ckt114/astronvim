function _G.hl(colors)
  ...
  local cursorbg     = vim.o.background == "dark" and not flat and colors.TreeBackground or colors.VertSplit
  local cursornrbg   = colors.CursorLineNr
  local hiddenfg     = colors.HiddenFile
  local treebg       = flat and bg or colors.TreeBackground
  local treecursorbg = vim.o.background == "dark" and not flat and bg or colors.VertSplit
